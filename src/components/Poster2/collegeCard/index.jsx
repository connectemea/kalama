...
function index({ college }) {
    ...
    const BgRank = ({ color }) => (
        <svg width="34" height="42" viewBox="0 0 47 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    function pickBorderColor(rank) {
        if (rank === 1) {
            return 'border-[#D71F30]'
        } else if (rank === 2) {
            return 'border-[#15A352]'
        } else if (rank === 3) {
            return 'border-[#EA9223]'
        } else if (rank === 4) {
            return 'border-[#F23105]'
        } else if (rank === 5) {
            return 'border-[#C60879]'
        } else {
