        ...
        <div className="z-10">
            ...
            <div className='mt-2'>
                ...
                <div className='flex items-center justify-between max-w-[360px] mx-auto my-4'>
                    ...
                    <button disabled={false} className="flex items-center gap-2 disabled:bg-gray-300 disabled:cursor-not-allowed border border-gray-700 px-2 text-[13px] py-1" onClick={() => handleShare()}>
